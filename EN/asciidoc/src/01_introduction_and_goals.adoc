...
.Contents
The main purpose of Housing system is keeping track of all the rental objects, tenants information, billings, consumptions and sensor management so that the landlord has all the informations updated.
...
| _Customer_ | _<Landlord>_ | 1. What is your business? What are you doing? +
